...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lastNameLineEdit.setGeometry(QRect(270, 120, 231, 31))
        self.lastNameLineEdit.setFont(font)
        self.lastNameLineEdit.setLocale(QLocale(QLocale.Finnish, QLocale.Finland))
        self.firstNameLable = QLabel(self.centralwidget)
        self.firstNameLable.setObjectName(u"firstNameLable")
        self.firstNameLable.setGeometry(QRect(30, 100, 71, 21))
        self.lastNameLable = QLabel(self.centralwidget)
        self.lastNameLable.setObjectName(u"lastNameLable")
        self.lastNameLable.setGeometry(QRect(280, 100, 71, 21))
        self.barcodeLabel = QLabel(self.centralwidget)
        self.barcodeLabel.setObjectName(u"barcodeLabel")
        self.barcodeLabel.setGeometry(QRect(50, 190, 201, 81))
        font1 = QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.firstNameLable.setText(QCoreApplication.translate("MainWindow", u"Etunimi", None))
        self.lastNameLable.setText(QCoreApplication.translate("MainWindow", u"Sukunimi", None))
        ...
        self.amountLable.setText(QCoreApplication.translate("MainWindow", u"Etikettien m\u00e4\u00e4r\u00e4", None))
