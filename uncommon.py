...
while True:
    ...
    if characterValue < 32:
        print("Kirjaimen", text, "väin 0-31 merkkejä ei voi käyttää!")
        ...
        print("Viivakoodin varmistussummaa laskettaessaarvo on", code128Value)
    elif characterValue == 127:
        print("Kirjaimen", text, "arvo on 127, mutta se ei ole sallittu merkki")
    elif characterValue < 195:
        print("Kirjaimen", text, "välin 127 - 194 merkkejä ei voi käyttä")
    elif characterValue > 202:
        print("Kirjaimen", text, "merkkejä, joiden arvo on yli 202 ei voi käyttää!")
    else:
        print("Kirjaimen", text, "arvo on suuri kuin 127, se on vähintään 8 bittinen")
